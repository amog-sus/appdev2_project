...
class _MapOfEuropeNorwayState extends State<MapOfEuropeNorway> {
  ...
  List<Country> countries = [
    ...
    Country("es", "Spain", "Madrid", Price.low, Temperature.warm, List.of([Language("Spanish")])),
    Country("de", "Germany", "Berlin", Price.medium, Temperature.comfortable, List.of([Language("German")])),
    Country("ro", "Romania", "Bucharest", Price.low, Temperature.comfortable, List.of([Language("Romanian")])),
    Country("pl", "Poland", "Warsaw", Price.medium, Temperature.cold, List.of([Language("Polish")])),
    Country("by", "Belarus", "Minsk", Price.low, Temperature.cold, List.of([Language("Belarusian"), Language("Russian")])),
    Country("it", "Italy", "Rome", Price.medium, Temperature.warm, List.of([Language("Italian")])),
    Country("gr", "Greece", "Athens", Price.high, Temperature.warm, List.of([Language("Greek")])),
    Country("ee", "Estonia", "Tallinn", Price.low, Temperature.cold, List.of([Language("Estonian")])),
  ];
  String currentId = "se";
...
class _LocationInfoPageState extends State<LocationInfoPage> {
  List<Country> countries = [
    ...
    Country("ro", "Romania", "Bucharest", Price.low, Temperature.comfortable, List.of([Language("Romanian")])),
    Country("pl", "Poland", "Warsaw", Price.medium, Temperature.cold, List.of([Language("Polish")])),
    Country("be", "Belarus", "Minsk", Price.low, Temperature.cold, List.of([Language("Belarusian"), Language("Russian")])),
    Country("it", "Italy", "Rome", Price.medium, Temperature.warm, List.of([Language("Italian")])),
    Country("gr", "Greece", "Athens", Price.high, Temperature.warm, List.of([Language("Greek")])),
    Country("ee", "Estonia", "Tallinn", Price.low, Temperature.cold, List.of([Language("Estonian")])),
  ];
